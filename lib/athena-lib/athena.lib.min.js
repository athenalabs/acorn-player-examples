...
function(a,b,e){return mixpanel.track(a,b,e)};a.prototype.register=function(a){return mixpanel.register(a)};a.prototype.unregister=function(a){return mixpanel.unregister(a)};a.prototype.disable=function(a){return mixpanel.disable(a)};a.prototype.bootstrap=function(){return function(a,b){window.mixpanel=b;var e,f,g,h;e=a.createElement("script");e.type="text/javascript";e.async=!0;e.src=("https:"===a.location.protocol?"https:":"http:")+"//cdn.mxpnl.com/libs/mixpanel-2.2.min.js";f=a.getElementsByTagName("script")[0];
f.parentNode.insertBefore(e,f);b._i=[];b.init=function(a,d,e){function f(a,d){var b=d.split(".");2==b.length&&(a=a[b[0]],d=b[1]);a[d]=function(){a.push([d].concat(Array.prototype.slice.call(arguments,0)))}}var k=b;"undefined"!==typeof e?k=b[e]=[]:e="mixpanel";k.people=k.people||[];g="disable track track_pageview track_links track_forms register register_once unregister identify alias name_tag set_config people.set people.increment people.track_charge people.append".split(" ");for(h=0;h<g.length;h++)f(k,
g[h]);b._i.push([a,d,e])};b.__SV=1.2}(document,window.mixpanel||[])};return a}(athena.lib.TrackerInterface);__bind=function(b,a){return function(){return b.apply(a,arguments)}};__hasProp={}.hasOwnProperty;__extends=function(b,a){function d(){this.constructor=b}for(var c in a)__hasProp.call(a,c)&&(b[c]=a[c]);d.prototype=a.prototype;b.prototype=new d;b.__super__=a.prototype;return b};
athena.lib.NullTracker=function(b){function a(){this.disable=__bind(this.disable,this);this.unregister=__bind(this.unregister,this);this.register=__bind(this.register,this);this.track=__bind(this.track,this);this.identify=__bind(this.identify,this);return a.__super__.constructor.apply(this,arguments)}__extends(a,b);a.prototype.identify=function(){};a.prototype.track=function(){};a.prototype.register=function(){};a.prototype.unregister=function(){};a.prototype.disable=function(){};return a}(athena.lib.TrackerInterface);__bind=function(b,a){return function(){return b.apply(a,arguments)}};__hasProp={}.hasOwnProperty;__extends=function(b,a){function d(){this.constructor=b}for(var c in a)__hasProp.call(a,c)&&(b[c]=a[c]);d.prototype=a.prototype;b.prototype=new d;b.__super__=a.prototype;return b};
...
e,f,g,h;g=this.trackers;h=[];e=0;for(f=g.length;e<f;e++)b=g[e],h.push(b.identify(a));return h};a.prototype.track=function(a,b,e){var f,g,h,i,j;i=this.trackers;j=[];g=0;for(h=i.length;g<h;g++)f=i[g],j.push(f.track(a,b,e));return j};a.prototype.register=function(a){var b,e,f,g,h;g=this.trackers;h=[];e=0;for(f=g.length;e<f;e++)b=g[e],h.push(b.register(a));return h};a.prototype.unregister=function(a){var b,e,f,g,h;g=this.trackers;h=[];e=0;for(f=g.length;e<f;e++)b=g[e],h.push(b.unregister(a));return h};
...
test.describeProperty=function(b,a,d,c){var e,f,g,h;null==d&&(d={});"function"===typeof d&&null==c&&(c=d,d={});f=null!=(g=d.modelOptions)?g:{};null==d.setter&&(d.setter=!0);e=null!=(h=d.dataProperty)?h:a;return describe(""+b.name+"::"+a,function(){it("should be a function",function(){return expect(typeof b.prototype[a]).toBe("function")});it("should get the value of the attribute",function(){var c,h;c=new b(f);expect(c[a]()).toEqual((h=d["default"])!=null?h:c.get(e));c.set(e,"foo");expect(c[a]()).toEqual(c.get(e));
return expect(c[a]()).toEqual("foo")});d.setter===false?it("should NOT set the value of the attribute (setter is false)",function(){var c,h,g,l;c=new b(f);expect(c[a]()).toEqual((h=d["default"])!=null?h:c.get(e));expect(c[a]()).not.toEqual("foo");expect(c[a]("foo")).toEqual((g=d["default"])!=null?g:c.get(e));expect(c[a]()).toEqual((l=d["default"])!=null?l:c.get(e));return expect(c[a]()).not.toEqual("foo")}):it("should set the value of the attribute",function(){var c,h;c=new b(f);expect(c[a]()).not.toEqual("foo");
expect(c[a]()).toEqual((h=d["default"])!=null?h:c.get(e));expect(c[a]("foo")).toEqual(c.get(e));return expect(c[a]()).toEqual("foo")});it("should use default value "+d["default"],function(){var c;c=new b(f);d["default"]!=null&&expect(c.get(e)).not.toEqual(d["default"]);return c.get(e)?expect(c[a]()).toEqual(c.get(e)):f[a]!=null&&f[a]!==d["default"]?expect(c[a]()).not.toEqual(d["default"]):expect(c[a]()).toEqual(d["default"])});return typeof c==="function"?c():void 0})};
test.describeView=function(b,a,d,c){"function"===typeof d&&(c=d,d={});null==d&&(d={});return describe(""+b.name+": view tests",function(){it("should be a function",function(){return expect(typeof b).toBe("function")});it("should derive from "+a.name,function(){return expect(athena.lib.util.derives(b,a)).toBe(true)});it("should be constructible with given options",function(){var a;expect(function(){return new b(d)}).not.toThrow();a=new b(d);expect(a instanceof b).toBe(true);return expect(a.options).toBe(d)});
...
function(){var a;a=new b(d);expect(a.rendering).toBe(false);a.render();return expect(a.rendering).toBe(true)});return typeof c==="function"?c():void 0})};test.describeDefaults=function(b,a,d){null==d&&(d={});return describe(""+b.name+"::defaults",function(){var c;c=(new b(d)).defaults();return _.each(a,function(a,b){return it("should have options."+b+" default to "+JSON.stringify(a),function(){return expect(c[b]).toEqual(a)})})})};
...
b.prototype.callsSinceLastCheck=function(){var a;a=this._callsSinceLastCheck;this._callsSinceLastCheck=0;return a};return b}();test.expectEventSpyBehaviors=function(b,a){var d,c,e,f,g,h,i,j,m,l,k;k=[];j=0;for(m=a.length;j<m;j++)g=a[j],e=null!=(l=g())?l:{},k.push(function(){var a;a=[];for(i in b)h=b[i],f=e.hasOwnProperty(i),c=h.callsSinceLastCheck(),expect(!!c).toBe(f),f&&null!=(d=e[i])?(_.isArray(d)||(d=[d]),a.push(expect(_.last(h.arguments)).toEqual(d))):a.push(void 0);return a}());return k};
...
return this};return a}(athena.lib.View);__bind=function(b,a){return function(){return b.apply(a,arguments)}};__hasProp={}.hasOwnProperty;__extends=function(b,a){function d(){this.constructor=b}for(var c in a)__hasProp.call(a,c)&&(b[c]=a[c]);d.prototype=a.prototype;b.prototype=new d;b.__super__=a.prototype;return b};
athena.lib.PageView=function(b){function a(){this.render=__bind(this.render,this);this.defaults=__bind(this.defaults,this);return a.__super__.constructor.apply(this,arguments)}__extends(a,b);a.prototype.className=a.classNameExtend("page-view");a.prototype.defaults=function(){return _.extend(a.__super__.defaults.apply(this,arguments),{refreshScroll:!0})};a.prototype.render=function(){a.__super__.render.apply(this,arguments);this.options.refreshScroll&&scrollTo(0,0);return this};return a}(athena.lib.ContainerView);__bind=function(b,a){return function(){return b.apply(a,arguments)}};
athena.lib.App=function(){function b(a){this.options=a;this.start=__bind(this.start,this);this.showPage=__bind(this.showPage,this);this.initializeAnalytics=__bind(this.initializeAnalytics,this);this.initialize=__bind(this.initialize,this);this.eventhub=this;this.initialize()}_.extend(b.prototype,Backbone.Events);b.prototype.View=athena.lib.PageView;b.prototype.Router=athena.lib.Router;b.prototype.initialize=function(){this.view=new this.View({eventhub:this.eventhub});this.router=new this.Router({eventhub:this.eventhub,
app:this});return this.initializeAnalytics()};b.prototype.initializeAnalytics=function(){var a;if("undefined"!==typeof config&&null!==config&&(null!=config.MIXPANEL_TOKEN&&(a=config.MIXPANEL_TOKEN,this.mixpanel=new athena.lib.MixpanelTracker(a)),null!=config.GOOGLE_ANALYTICS_TRACKER_ID))a=config.GOOGLE_ANALYTICS_TRACKER_ID,this.ga=new athena.lib.GoogleAnalyticsTracker(a);null==this.mixpanel&&(this.mixpanel=new athena.lib.NullTracker);if(null==this.ga)return this.ga=new athena.lib.NullTracker};b.prototype.showPage=
function(a){this.view.content(a);if(!this.view.rendering)return this.view.render()};b.prototype.start=function(){return Backbone.history.start({pushState:!0})};return b}();var Popover,__bind=function(b,a){return function(){return b.apply(a,arguments)}},__hasProp={}.hasOwnProperty,__extends=function(b,a){function d(){this.constructor=b}for(var c in a)__hasProp.call(a,c)&&(b[c]=a[c]);d.prototype=a.prototype;b.prototype=new d;b.__super__=a.prototype;return b};
...
arguments)};return a}(athena.lib.ContainerView);Popover=$.fn.popover.Constructor;Popover.prototype._setContent=Popover.prototype.setContent;
...
Popover.prototype._applyPlacement=Popover.prototype.applyPlacement;Popover.prototype.applyPlacement=function(b,a){var d,c;return this._applyPlacement({top:b.top+(null!=(d=this.options.placementOffset.top)?d:0),left:b.left+(null!=(c=this.options.placementOffset.left)?c:0)},a)};Popover.prototype._replaceArrow=Popover.prototype.replaceArrow;
...
athena.lib.HeaderView=function(b){function a(){this.render=__bind(this.render,this);this.initialize=__bind(this.initialize,this);return a.__super__.constructor.apply(this,arguments)}__extends(a,b);a.prototype.className=a.classNameExtend("header-view");a.prototype.initialize=function(){a.__super__.initialize.apply(this,arguments);this.directiveView=new athena.lib.DirectiveView(this.options);return this.toolbarView=new athena.lib.ToolbarView(this.options)};a.prototype.render=function(){a.__super__.render.apply(this,
arguments);this.$el.empty();this.$el.append(this.directiveView.render().el);this.$el.append(this.toolbarView.render().el);return this};return a}(athena.lib.View);__bind=function(b,a){return function(){return b.apply(a,arguments)}};__hasProp={}.hasOwnProperty;__extends=function(b,a){function d(){this.constructor=b}for(var c in a)__hasProp.call(a,c)&&(b[c]=a[c]);d.prototype=a.prototype;b.prototype=new d;b.__super__=a.prototype;return b};
